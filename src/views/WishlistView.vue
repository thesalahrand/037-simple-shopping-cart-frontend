    ...
    <div class="grid grid-cols-4 gap-4">
      ...
      >
        <div class="relative">
          ...
          />
          <div
            class="p-2 top-2 right-2 absolute z-10 bg-white cursor-pointer rounded-full"
            @click="wishlistStore.removeProduct(product.id)"
          >
            <IconXMark v-show="!product.added_to_cart" classes="w-6 h-6 text-red-500" />
          </div>
        </div>
        <div class="p-4">
          <a href="#">
